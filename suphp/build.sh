...
echo "--------------------------------------------------------------"
#
aptitude -y install libapache2-mod-suphp libapache2-mod-php5 php5-cgi php5-cli php5-mysql php5-curl php5-gd php5-imagick php5-mcrypt php5-memcache php5-mhash php5-pspell php5-suhosin php5-xmlrpc php5-xsl
#
a2dismod php5
#
a2enmod suphp
...
echo
echo
echo "Changing PHP settings (we actually won't use these with suPHP though)"
echo "--------------------------------------------------------------"
echo
#
...
<VirtualHost *:80>
    ...
    suPHP_ConfigPath /home/$USER/public_html/$DOMAIN/
